...
import {sendEmail, modify} from "../../action/user";
...
import {hiddenForget, showLogin} from "../../action/controller";
...
function Forget(props:any) {
    ...
    return (
        <div style={{
            ...
            <Background color={'rgb(33, 33, 33)'} onClick={() => props.hiddenForget()}></Background>
            <div style={{
                backgroundColor: '#fff',
                width: '30%',
                height: '60%',
                ...
                <FormControl fullWidth={true} sx={{ m: 1, width: '100%' }} variant="standard">
                    ...
                    <Input
                        ...
                        onKeyDown={(event) => {
                            if (event.key === 'Enter')
                                props.modify(values.email, values.password, values.code)
                        }}
                    />
                </FormControl>
                {/*注册码*/}
                ...
                <div style={{
                    ...
                    <p style={{color: 'black', cursor: 'pointer'}} onClick={() => {props.showLogin(); props.hiddenForget()}}>已有账号？登录</p>
                </div>
            </div>
        </div>
    );
...
const mapDispatchToProps = {
    ...
    modify(email:string, password:string, code: string) {
        // 验证
        ...
        //     return null
        // }
        return modify(email, password, code);
    },
